...
|------|--------|----------|
| Create market | `create-market.js` | `/scripts/live/` |
| Check markets | `check-markets.js` | `/scripts/live/` |
| Monitor system | `monitor-mainnet.js` | `/scripts/live/` |
| Resolve market | `resolve-market.js` | `/scripts/live/` |
| Check balances | `check-balance.js` | `/scripts/live/` |
| Admin approve | `admin-approve.js` | `/scripts/live/` |
...
**System Status**: LIVE
**Support**: See [MONITORING.md](./MONITORING.md) for system health